            ...
            <form action="{{ route('tasques.update', $tasques->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <select name="stat" id="stat" class="form-select" required>
                        <option value="pendent" {{ old('stat', $tasques->stat) == 'pendent' ? 'selected' : '' }}>Pendent</option>
                        <option value="en_curs" {{ old('stat', $tasques->stat) == 'en_curs' ? 'selected' : '' }}>En curs</option>
                        <option value="completada" {{ old('stat', $tasques->stat) == 'completada' ? 'selected' : '' }}>Completada</option>
                    </select>
                </div>
